"""Polars benchmark workload for BRZ_02 accounts Bronze ingestion."""
...
def _polars_schema() -> dict[str, object]:
    ...
    return {field.name: pl.String for field in BRONZE_ACCOUNTS_SCHEMA.fields}
...
def run(
    *,
    ...
    accounts_with_ts.write_delta(str(output_path), mode="overwrite")
    ...
    return BenchmarkExecution(
        ...
        notes=(
            "Polars Bronze accounts ingest benchmark"
